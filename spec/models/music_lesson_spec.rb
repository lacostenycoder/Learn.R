...
describe MusicLesson do
  subject(:music_lesson) {MusicLesson.create(
                            points: 10, level: 10, img: "http://google.com/me.jpg", lesson_text: "This is a test for music", question_text: "What are we testing today?", solution_key_pattern: "B5, H6, I7")}
